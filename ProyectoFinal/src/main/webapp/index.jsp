...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav justify-content-end">
				<li class="nav-item"><a href="#" class="nav-link">Profesores</a>
				</li>
			</ul>
		</div>
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu  text-center">
				...
				<a class="dropdown-item" href="inicioSesion?accion=true">Salir</a>
			</div>
		</div>
	</nav>
	...
	<main>
		<div class="container">
			<div>
				<a style="margin: 10px" class="btn btn-success" role="button"
					href="#"> <i class="fas fa-user-plus"></i>
				</a>
			</div>
